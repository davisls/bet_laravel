    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-12 col-md-5 card-personalizado text-center mx-auto my-4">
                ...
                <p>Aposte a quantia que você quiser com uma chance de 50%
            ...
            <div class="col-12 col-md-5 card-personalizado text-center mx-auto my-4">
                ...
                <p>Aposte a quantia que você quiser com uma chance de 20%
        ...
        <div class="row">
            <div class="col-12 col-md-5 card-personalizado text-center mx-auto my-4">
                ...
                <p>Aposte a quantia que você quiser com uma chance de 10%
            ...
            <div class="col-12 col-md-5 card-personalizado text-center mx-auto my-4">
                ...
                <p>Aposte a quantia que você quiser com uma chance de 1%
